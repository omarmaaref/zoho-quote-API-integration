...
- base implementation of new enrlomment module

### 🧱 Updated Dependencies

- Updated zoho-types to 0.9.0
...
- bug on upsert zoho internal module
...
- Updated zoho-types to 0.2.0

## 0.2.1 (2025-06-16)

### 🩹 Fixes

- missing header on zoho internal create request and finish QP Creation

### 🧱 Updated Dependencies

- Updated zoho-types to 0.1.0
...
This was a version bump only for zoho-connector to align it with other projects, there were no code changes.
