...
**Important**: Set the `ZOHO_CRM_SOID` to your development Zoho CRM organization ID. This is a critical environment variable that determines which Zoho organization the service connects to.
...
**Important**: Set the `ZOHO_CRM_SOID` to your production Zoho CRM organization ID. This is different from the development SOID and is a critical environment variable that determines which Zoho organization the service connects to.
